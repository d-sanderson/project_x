...
type SiteSiteMetadataFilterInput = {
  ...
  readonly topHeader: Maybe<SiteSiteMetadataTopHeaderFilterInput>;
  readonly about: Maybe<SiteSiteMetadataAboutFilterInput>;
};

type SiteSiteMetadataTopHeaderFilterInput = {
  readonly superTitle: Maybe<StringQueryOperatorInput>;
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.author'
  | 'siteMetadata.topHeader.superTitle'
  | 'siteMetadata.topHeader.subTitle'
  | 'siteMetadata.about.title'
  | 'siteMetadata.about.content'
  | 'port'
  | 'host'
  | 'polyfill'
  | 'pathPrefix'
...
type siteMetaDataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      ...
      & { readonly topHeader: Maybe<Pick<SiteSiteMetadataTopHeader, 'superTitle' | 'subTitle'>>, readonly about: Maybe<Pick<SiteSiteMetadataAbout, 'title' | 'content'>> }
    )> }> };

type SiteTitleQueryQueryVariables = Exact<{ [key: string]: never; }>;


type SiteTitleQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }> };
